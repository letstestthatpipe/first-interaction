...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let mySec = process.env.HERE_WE_ARE
            
            console.log('we got for env: ' + mySec);
            ...
            console.log('checking user orgs');
            
console.log('The sender is: ' + sender);            
const { status, data: membership } = yield client.orgs.checkMembership({
  org: 'letstestthatpipe',
  username: sender
});
         ...
         if (status !== 204) {
            ...
            console.log('got responsoe for org membership: ' + membership);
